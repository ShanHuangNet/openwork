...
export default {
  ...
  "context_panel.run_mode": "Run mode for this workspace",
  "context_panel.run_mode_desc": "Sets the catch-all permission rule in this workspace's opencode.json, exactly as an OpenCode user would write it. Narrower rules in the file stay in place.",
  "context_panel.run_mode_label": "Run mode",
  "context_panel.run_mode_default": "Engine default",
  "context_panel.run_mode_default_desc": "No catch-all rule. The engine asks only before working outside authorized folders, reading .env files, and repeating an identical call, plus whatever narrower rules say.",
  "context_panel.run_mode_approve": "Approve each step",
  "context_panel.run_mode_approve_desc": "Writes \"*\": \"ask\". Every tool asks first unless a narrower rule allows it.",
  "context_panel.run_mode_run_everything": "Run everything",
  "context_panel.run_mode_run_everything_desc": "Writes \"*\": \"allow\", the same as OpenCode's own \"permission\": \"allow\". Every tool runs without asking — including working outside authorized folders and repeating an identical call — unless a narrower rule in this file asks or denies. Because the workspace file is read last, it also overrides catch-all and deny rules in your global opencode.json.",
  "context_panel.run_mode_blocked": "Blocked",
  "context_panel.run_mode_blocked_desc": "The file's catch-all is \"deny\". Change it in opencode.json to pick a mode here.",
  "context_panel.run_mode_preview": "This writes to {path}:",
  "context_panel.run_mode_apply": "Write to opencode.json",
  "context_panel.run_mode_cancel": "Cancel",
  "context_panel.run_mode_saved": "opencode.json updated.",
  "context_panel.run_mode_saved_deferred": "opencode.json updated; the engine picks it up when this workspace's current run finishes.",
  "context_panel.run_mode_unavailable": "Connect to a writable OpenWork server workspace to change the run mode.",
